  ...
  return gulp.src(['production/css/main.min.css',path.src.purgingcss])
       .pipe(
            purgecss({
                ...
                whitelistPatterns: [/\bjs_/, /active/, /\bslick-/, /\bicon-/, /\bchosen-/, /\bcbox/, /colorbox/, /\blombard/, /\bgm/, /\bnivo/, /static-page-content/, /alert/, /alert-success/, /staticPage/, /h4/, /p/, /ul/, /li/, /static-page-content/, /content-about-page/]
            })
        )
