  ...
  return gulp.src(['production/css/main.min.css',path.src.purgingcss])
       .pipe(
            purgecss({
                ...
                whitelistPatterns: [/\bjs_/, /active/, /\bslick-/, /\bicon-/, /\bchosen-/, /\bcbox/, /colorbox/, /\blombard/, /nav-open/, /line-fade-out/, /line-cross/, /fade-in/, /before-line--active/, /active-filter/, /actived/, /prod__visible/, /drop-item__active/, /before-title__active/, /form-actived/,/nav/, /pagination/, /flex-end-item/, /page-link/, /descMenu/, /category-sidebar/, /select2-container--above/, /select2-container--default/, /select2.select2-container/, /select2-selection--single/, /select2-container/, /select2-container--default/, /select2-selection__rendered/, /select2-selection__arrow/, /select2/, /select2-container--below/, /select2-container--focus/, /select2-selection/, /select2-container--below/, /sort-by/, /help-block/, /page-item/, /disabled/, /pos-rel/, /bgc-el/, /border-active-el/, /flex-wrap-filter/, /\bgm/]
            })
        )
