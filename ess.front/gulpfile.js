  ...
  return gulp.src(['production/css/main.min.css',path.src.purgingcss])
       .pipe(
            purgecss({
                ...
                whitelistPatterns: [/\bjs_/, /active/, /\bslick-/, /\bicon-/, /\bchosen-/, /\bcbox/, /colorbox/, /\blombard/, /ui-slider/, /ui-slider-handle/, /ui-slider-horizontal/, /noUi-handle/, /noUi-horizontal/, /nav-open/, /fade-in/, /line-cross/, /line-fade-out/, /img-show__js/, /pattern/, /btn-hidden/, /hiden-btn/, /mouse-out-slide/, /active-icon/, /overlay__active/, /text-center/, /notification-modal/, /visible/, /hidden/, /\bgm/]
            })
        )
