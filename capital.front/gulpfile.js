  ...
  return gulp.src(['production/css/main.min.css',path.src.purgingcss])
       .pipe(
            purgecss({
                ...
                whitelistPatterns: [/\bjs_/, /active/, /\bslick-/, /\bicon-/, /\bchosen-/, /\bcbox/, /colorbox/, /\blombard/, /\bgm/, /\bui-/, /\bdepartment_chosen./, /\bdz-/, /links-section/, /link-btn/, /page-links/, /\wysiwyg/, /evalDepPage/, /disabled/, /canvas/]
            })
        )
