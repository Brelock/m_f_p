  ...
  return gulp.src(['production/css/main.min.css',path.src.purgingcss])
       .pipe(
            purgecss({
                ...
                whitelistPatterns: [/\bjs_/, /active/, /\bslick-/, /\bicon-/, /\bchosen-/, /\bcbox/, /colorbox/, /\blombard/, /\bgm/, /hidePayment_js/, /hidePost_js/, /hide_js/, /overlay_js/, /height_auto_js/,/prev/,/next/, /heightAuto/, /card-product-zero/, /open-accordion/, /product-item-block-zero/, /active-filter/, /active-filter-rev/, /quantity/, /comment-xml/, /link-xml/, /icon/, /name-xml/, /icon-title/, /ui-sortable/, /file/, /url/, /btn-edit/, /icon-container/, /flex-cols/, /thumb/]
            })
        )
